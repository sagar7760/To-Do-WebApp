...
const TodoPage = ({ darkMode, onBackToHome }) => {
  ...
  return (
    <>
      <Navbar darkMode={darkMode} onBackToHome={onBackToHome} />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {getFilteredTasks().map(task => (
                <div
                  key={task.id}
                  className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow duration-200`}
                >
                      ...
                      {task.deleted ? (
                        <button
                          ...
                          className={`p-2 rounded-lg transition-colors duration-200 ${
                            darkMode ? 'text-gray-400 hover:text-green-400 hover:bg-gray-700' : 'text-gray-500 hover:text-green-600 hover:bg-gray-100'
                          }`}
                          title="Restore"
                        >
                        ...
                        <button
                          ...
                          className={`p-2 rounded-lg transition-colors duration-200 ${
                            darkMode ? 'text-gray-400 hover:text-red-400 hover:bg-gray-700' : 'text-gray-500 hover:text-red-600 hover:bg-gray-100'
                          }`}
                          title="Delete"
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
